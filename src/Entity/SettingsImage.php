 ...
 * Images
 *
 * @ORM\Table(name="settings_image", uniqueConstraints={@ORM\UniqueConstraint(name="id", columns={"id"})})
 * @ORM\Entity(repositoryClass="App\Repository\SettingsImageRepository")
 */
class SettingsImage
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="value_mobile", type="string", length=250, nullable=true)
     */
    private $valueMobile = null;
    ...
    public function getValueMobile(): ?string
    {
