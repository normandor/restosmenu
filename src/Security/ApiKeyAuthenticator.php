...
{
///////////////////////////////////////////// todo: check https://symfony.com/doc/current/security/guard_authentication.html
///
    private $API_KEY = 'cb51bbea-5ec0-11e9-8647-d663bd873d93';
...
//        }
        ...
        if (!$token || !$apiKey || $this->API_KEY != $apiKey)
        {
    ...
    public function authenticateToken(TokenInterface $token, UserProviderInterface $userProvider, $providerKey)
    {
        ...
        $username = $userProvider->getUsernameForAuthToken($authToken);
        ...
        return new PreAuthenticatedToken(
                $user, $authToken, $providerKey, $user->getRoles()
        );
    }
